      ...
      <div class="back">
        <div class="row my-2">
          <div class=" col-md-6">
            ...
            <form action="cart_order_action.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group from">
                ...
                <input type="float" class="form-control btn btn-outline-light" style="text-align: left; color:black;" id="price" placeholder="Enter your price" name="price" value="<?php echo $data['total_price']; ?>" readonly>
              </div>
              <div class="form-group from">
