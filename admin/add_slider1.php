...
<body>
  ...
  <section>
    <div class="container-fluid">
      <div class="row my-4" style="margin: 22%; background-color:#000;">
        <div class=" col-md-12">
          <h1 class="text-center text-light">Add Slider11</h1>
          <form action="add_slider1_action.php" method="post" enctype="multipart/form-data">
            <div class="form-group from">
              <label for="slider1" class="text-light">slider1</label>
              <input type="text" class="form-control btn btn-outline-light" style="text-align: left;" id="slider1" placeholder="slider1 name" name="slider1">
            </div>
            
            <div class="row">
              
              <div class="form-group from col-md-6">
                <label for="slider1_status" class="text-light">slider1 Status:</label><br>
                <div class="form-check-inline">
                  <label class="form-check-label">
                    <input type="radio" id="available" value="available" class="form-check-input " name="slider1_status"><span class="text-white">Available</span>
                  </label>
                </div>
                <div class="form-check-inline">
                  <label class="form-check-label">
                    <input type="radio" id="unavailable" value="unavailable" class="form-check-input" name="slider1_status"><span class="text-white">Unavailable</span>
                  </label>
                </div>
              </div>
            </div>
  ...
  <script>
    function formValidate() {
      ...
      if (slider1 == "" || slider1 == " ") {
        alert("Please Enter slider1 name.....");
