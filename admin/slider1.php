                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="rounded h-100 p-4 alluser">
                            <h4 class="mb-4 text-light fs-5 fw-5">All slider1 <a href="add_slider1.php" class="btn btn-outline-warning py-1 px-2 now" style="margin-left: 80%;">+Add slider1</a></h4>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-light"><?php echo $data['slider1']; ?></td>
                                                    
                                                    
                                                    <td class="text-light"><?php echo $data['slider1_status']; ?></td>
                                                    
                                                    <td><img src="../assets/slider_img/<?php echo $data['image'] !='' ? $data['image'] : 'no-img.jpg'; ?>" alt=" " style="height:50px;" id="view_profile_pic"></td>
                                                               
                                                    <td>
                                                        <a href="edit_slider1.php?uid=<?php echo base64_encode($data['s1_id']); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                        <a href="delete_slider1.php?uid=<?php echo $data['s1_id']; ?>" class="btn btn-sm btn-danger delete_btn" onclick="return confirm('Are you sure');"><i class="fa fa-trash"></i></a>
                                                    </td>
