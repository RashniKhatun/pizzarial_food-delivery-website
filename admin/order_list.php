                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="rounded h-100 p-4 alluser">
                            <h4 class="mb-4 text-light fs-5 fw-5">All Order </h4>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-light"><?php echo $data['order_date']; ?></td>
                                                    <td class="text-light"><?php echo $data['cus_name']; ?></td>
                                                    
                                                    <td class="text-light"><?php echo $data['phone_no']; ?></td>
                                                    <td class="text-light"><?php echo $data['pincode']; ?></td>
                                                    <td class="text-light"><?php echo $data['city']; ?></td>
                                                    <td class="text-light"><?php echo $data['state']; ?></td>
                                                    <td class="text-light"><?php echo $data['food']; ?></td>
                                                    <td class="text-light"><?php echo $data['price']; ?></td>
                                                    <td class="text-light"><?php echo $data['house']; ?></td>
                                                    <td class="text-light"><?php echo $data['payment_status']; ?></td>
                                                    <td>
                                                        <a href="edit_order.php?uid=<?php echo base64_encode($data['o_id']); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                        <a href="delete_order.php?uid=<?php echo $data['o_id']; ?>" class="btn btn-sm btn-danger delete_btn" onclick="return confirm('Are you sure');"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
