...
<body>
    <div class="container-fluid bg-secondary m-0 p-0">
            ...
            <div class="row edit_back">
                ...
                <h2 class="text-light">Edit Category</h2>
            </div>
                    <form action="edit_category_action.php" class="needs-validation edit" novalidate="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="user_id" value="<?php echo $data['c_id']; ?>" />
                        <div class="row g-2">
                        <div class="col-12">
                                <label for="category" class="form-label text-light">Category:</label>
                                <input type="text" class="form-control bg-secondary" name="category" id="category" placeholder="1234 Main St" required="" value="<?php echo $data['category'] ?>">
                        ...
                        <hr class="my-4">
                        <h4 class="mb-3 text-light">Category Status</h4>
                        <div class="my-3">
                            <div class="form-check">
                                <input id="available" value="available" name="category_status" type="radio" class="form-check-input" checked="" required="" <?php echo $data['category_status'] == 'Male' ? 'checked' : ''; ?>>
                                <label class="form-check-label text-light" for="available">Available</label>
                            </div>
                            <div class="form-check">
                                <input id="unavailable" value="unavailable" name="category_status" type="radio" class="form-check-input" required="" <?php echo $data['category_status'] == 'Female' ? 'checked' : ''; ?>>
                        ...
                        <hr class="my-4">
                        <button class="w-100 btn btn-warning btn-lg" type="submit" fdprocessedid="g2865" name="categoryEditBtn">Submit</button><br>
                    </form>
                </div>
            </div>
            </div>
