  ...
  <section>
    <div class="container-fluid">
      <div class="row my-4" style="margin: 22%; background-color:#000;">
        <div class=" col-md-12">
          <h1 class="text-center text-light">Add Service</h1>
          <form action="add_service_action.php" method="post" enctype="multipart/form-data">
            <div class="form-group from">
              ...
              <input type="text" class="form-control btn btn-outline-light" style="text-align: left;" id="service" placeholder="service name" name="service">
            </div>
            
            <div class="row">
              
              <div class="form-group from col-md-6">
                <label for="service_status" class="text-light">service Status:</label><br>
                <div class="form-check-inline">
                  <label class="form-check-label">
                    <input type="radio" id="available" value="available" class="form-check-input " name="service_status"><span class="text-white">Available</span>
                  </label>
                </div>
                <div class="form-check-inline">
                  <label class="form-check-label">
                    <input type="radio" id="unavailable" value="unavailable" class="form-check-input" name="service_status"><span class="text-white">Unavailable</span>
                  </label>
                </div>
              </div>
            </div>
