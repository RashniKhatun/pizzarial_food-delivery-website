        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row">
                    ...
                    <!-- <canvas class="w-100 chartjs-render-monitor" id="myChart" width="737" height="311" style="display: block; height: 249px; width: 590px;"></canvas> -->

                    <!-- <h2 class="text-light">Section title</h2> -->
                    <div class="col-md-12">
                        <div class="rounded h-100 p-4 alluser">
                            <h4 class="mb-4 text-light fs-5 fw-5">All Category <a href="add_category.php" class="btn btn-outline-warning py-1 px-2 now" style="margin-left: 80%;">+Add Category</a></h4>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-light"><?php echo $data['category']; ?></td>
                                                    
                                                    
                                                    <td class="text-light"><?php echo $data['category_status']; ?></td>
                                                    
                                                    <td><img src="../assets/category_img/<?php echo $data['image'] !='' ? $data['image'] : 'no-img.jpg'; ?>" alt=" " style="height:50px;" id="view_profile_pic"></td>
                                                               
                                                    <td>
                                                        <a href="edit_category.php?uid=<?php echo base64_encode($data['c_id']); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                        <a href="delete_category.php?uid=<?php echo $data['c_id']; ?>" class="btn btn-sm btn-danger delete_btn" onclick="return confirm('Are you sure');"><i class="fa fa-trash"></i></a>
                                                    </td>
