                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="rounded h-100 p-4 alluser">
                            <h4 class="mb-4 text-light fs-5 fw-5">All Contact</h4>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-light"><?php echo $data['name']; ?></td>
                                                    
                                                    
                                                    <td class="text-light"><?php echo $data['email']; ?></td>
                                                    <td class="text-light"><?php echo $data['phone_no']; ?></td>
                                                    <td class="text-light"><?php echo $data['message']; ?></td>
                                                    
                                                               
                                                    <td>
                                                        <a href="edit_contact.php?uid=<?php echo base64_encode($data['con_id']); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                        <a href="delete_contact.php?uid=<?php echo $data['con_id']; ?>" class="btn btn-sm btn-danger delete_btn" onclick="return confirm('Are you sure');"><i class="fa fa-trash"></i></a>
                                                    </td>
