                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="rounded h-100 p-4 alluser">
                            <h4 class="mb-4 text-light fs-5 fw-5">All Food <a href="add_food.php" class="btn btn-outline-warning py-1 px-2 now" style="margin-left: 80%;">+Add Food</a></h4>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-light"><?php echo $data['stock_count']; ?></td>
                                                    <td class="text-light"><?php echo $data['food_status']; ?></td>
                                                    <td><img src="../assets/food_img/<?php echo $data['image'] !='' ? $data['image'] : 'no-img.jpg'; ?>" alt=" " style="height:50px;" id="view_profile_pic"></td>
                                                               
                                                    <td>
                                                        <a href="edit_food.php?uid=<?php echo base64_encode($data['f_id']); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                        <a href="delete_food.php?uid=<?php echo $data['f_id']; ?>" class="btn btn-sm btn-danger delete_btn" onclick="return confirm('Are you sure');"><i class="fa fa-trash"></i></a>
                                                    </td>
