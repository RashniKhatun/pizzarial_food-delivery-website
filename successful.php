...
<body style="background-color:grey; margin-top:-25px;"><div>
    <div style="align-items:center; height:250px; width:650px;margin-left:350px;">
    <button class="truck-button" style="height:300px; width:300px; border-radius:200px;">
    <span class="default"><h1>Complete Order</h1></span>
    <span class="success">
       <h1 style="padding-top: 30%;"> Order Placed</h1>
        <svg viewbox="0 0 12 10" style="height: 10px;">
    ...
    <!-- <h1  style="margin-left:-70px;">Booking Successfully</h1> -->
   <a href="home.php"> <button style="margin-left:50px;padding:10px 20px;background-color:orange;border:none;border-radius:5px;">OK</button></a>
    </div>
