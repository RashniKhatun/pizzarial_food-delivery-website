  ...
  <div class="container-fluid">
    <div class="row">
      <!-- <div class="bg-banner"> -->
        ...
        <h2 class="about-header text-center">Pasta</h2>
      <!-- </div> -->
    </div>
    <div class="row">
        ...
        <!-- <div class="col-lg-3 col-md-3 col-6">
          <div class="cards" >
            ...
            <h2 class="txtcolor">Chicken Pasta</h2>
             ...
             <p class="my-4"><button style="background-color:black;">Add <i class="fa-solid fa-plus"></i><span class="m-button" style="color: aliceblue;">&#8377;139  <span class="m-button1">&#8377;200</span></span></button>
        ...
        <div class="col-lg-3 col-md-3 col-6">
          <div class="cards" >
            ...
            <h2 class="txtcolor">Italian Pasta</h2>
             ...
             <p class="my-4"><button style="background-color:black;">Add <i class="fa-solid fa-plus"></i><span class="m-button" style="color: aliceblue;">&#8377;110  <span class="m-button1">&#8377;200</span></span></button>
            <a  href="order_pizza.php"> <button class="my-2" style="width:70%; background-color: #fac564;">Order Now</button></a>
            </p>
          </div>
        </div>
